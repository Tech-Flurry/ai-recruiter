...
internal class CandidateListDtoResolver : ResolverBase<Interview, CandidateListDto> // ✅ Interview not Interviewee
{
	...
	public CandidateListDtoResolver( )
	{
		var config = new MapperConfiguration(cfg =>
		{
			cfg.CreateMap<Interview, CandidateListDto>( )
				...
				.ForMember(dest => dest.Status, opt => opt.MapFrom(src => "Screened"))
