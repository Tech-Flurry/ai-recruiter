											...
											<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24">
												<g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
													...
													<path
														...
														fill={copiedJobId === job.id ? "#009EF7" : "#5E6278"}
													/>
													<rect fill={copiedJobId === job.id ? "#009EF7" : "#5E6278"} opacity="0.3" x="7" y="10" width="5" height="2" rx="1" />
													<rect fill={copiedJobId === job.id ? "#009EF7" : "#5E6278"} opacity="0.3" x="7" y="14" width="9" height="2" rx="1" />
												</g>
											</svg>
										</button>
